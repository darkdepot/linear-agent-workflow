...
6. Preserve existing review gates: tiny advisory, standard Issue-only still runs required `linear-review`; preflight may raise; leaving the envelope returns to Project-first.
